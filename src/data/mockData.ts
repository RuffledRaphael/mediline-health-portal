...
export const mockTestResults: TestResult[] = [
  ...
  },
  {
    ...
    testType: 'Imaging',
    date: '2024-04-15',
    result: 'Normal lung fields, no acute findings',
    reportUrl: '/mock-reports/chest-xray.pdf',
    status: 'completed',
    performedBy: 'Dr. Michael Chen',
    notes: 'Clear lung fields with no signs of infection or structural abnormalities.',
  },
  {
    id: '4',
    patientId: '1',
    ...
    parameters: [
      { name: 'Protein', value: 'Negative', unit: '', normalRange: 'Negative', isNormal: true },
      { name: 'Glucose', value: 'Negative', unit: '', normalRange: 'Negative', isNormal: true },
      { name: 'Specific Gravity', value: '1.020', unit: '', normalRange: '1.005-1.030', isNormal: true },
    ],
  },
  {
    id: '5',
    ...
    status: 'completed',
    performedBy: 'Dr. Sarah Johnson',
    notes: 'Regular heart rhythm with no signs of arrhythmia or ischemia.',
  },
  {
    id: '6',
    patientId: '1',
    ...
    testType: 'Pathology',
    date: '2024-02-25',
    result: 'Liver enzymes slightly elevated',
    status: 'completed',
    performedBy: 'Dr. James Wilson',
    parameters: [
      { name: 'ALT', value: '45', unit: 'U/L', normalRange: '7-35', isNormal: false },
      { name: 'AST', value: '42', unit: 'U/L', normalRange: '8-35', isNormal: false },
      { name: 'Bilirubin Total', value: '1.1', unit: 'mg/dL', normalRange: '0.3-1.2', isNormal: true },
    ],
    notes: 'Mild elevation in liver enzymes. Recommend lifestyle modifications.',
  },
  {
    id: '7',
    patientId: '1',
    ...
    testType: 'Imaging',
    date: '2024-01-18',
    result: 'No acute intracranial abnormalities',
    reportUrl: '/mock-reports/mri-brain.pdf',
    status: 'completed',
    performedBy: 'Dr. Lisa Park',
    notes: 'Normal brain MRI with no evidence of structural abnormalities or acute pathology.',
  },
];

// Additional hospitals for test filtering
